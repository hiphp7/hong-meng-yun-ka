...
-- Records of hm_admin
-- ----------------------------
INSERT INTO `hm_admin` VALUES ('1', 'admin', 'Admin', '2e610eaa6f364c0119e4ff90c12a116e', '384ad3', '/assets/img/avatar.png', 'admin@admin.com', '0', '1620558613', '127.0.0.1', '1492186163', '1620558613', '96ab4d1a-93a2-4a0b-b61a-f7ba9fba56dc', 'normal');
...
CREATE TABLE `hm_cdkey` (
  ...
  `cdk` varchar(500) DEFAULT NULL COMMENT '内容',
...
CREATE TABLE `hm_config` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `name` (`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='系统配置';
...
INSERT INTO `hm_config` VALUES ('15', 'search_password', 'basic', '查单密码', '关闭后购买商品和邮箱查询订单时不需要填写密码', 'radio', '1', '{\"1\":\"开启\",\"0\":\"关闭\"}', '', '', '{\"table\":\"\",\"conditions\":\"\",\"key\":\"\",\"value\":\"\"}');
...
CREATE TABLE `hm_goods` (
  ...
  `goods_type` varchar(30) DEFAULT '0' COMMENT '0 卡密 1 激活码 2账号和密码 3图片 4其他',
...
-- ----------------------------
INSERT INTO `hm_template` VALUES ('1', 'default', '默认模板', '红盟云商', '1.0.2', '0', '/content/template/default/cover.jpg', '0', '0', '1');
